...
export function LightRays({
  ...
  useEffect(() => {
    ...
    const initializeWebGL = async () => {
      ...
      // OGL calls console.error then sets gl=null (doesn't throw) when WebGL is unavailable
      ...
      // Guard: if the GL context failed, gl is null — bail out silently
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer && renderer.gl) {
          // Permanently destroy canvas to free contexts
